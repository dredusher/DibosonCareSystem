...
public class ShoppingInputActivity extends DibosonActivity 
{
					...
					switch (type)
				   	{
				   		...
				   		case TYPE_ITEM:
				   			...
				   			// -----------------------------------------------------
				   			if (ShoppingItem.GetIndex (selectedBrand,selectedProduct) == StaticData.NO_RESULT)
				   			{
				   				if (selection == StaticData.NO_RESULT)
				   					ShoppingItem.Add (new ShoppingItem (selectedBrand,selectedProduct));
				   				else
				   					PublicData.shoppingData.items.set (selection,new ShoppingItem (selectedBrand,selectedProduct));
				   			}
				   			else
				   			{
				   				Utilities.popToast ("The item already exists.");
				   			}
				   			break;
				   		// ---------------------------------------------------------
				   		case TYPE_LIST:
				   		...
				   		case TYPE_TRANSACTION:
				   			...
				   			{
				   				Utilities.popToast ("The transaction already exists");
				   			}
				   			break;
				   		// ---------------------------------------------------------
				   	}
	...
	public static void deleteItem (int theType,int theSelection)
	{
		...
		DialogueUtilities.yesNo (Selector.context,"Item Deletion",
	    		   "Do you really want to delete the entry for '" + ShoppingActivity.selectorParameter.name + "'",
	    		   (Object) theSelection,
	...
	// =============================================================================
	public static void deleteItemConfirmed (int theType,int theSelection)
	{
		// -------------------------------------------------------------------------
	...
	void Spinners (int theType)
	{
		if (theType == TYPE_ITEM)
		{
			...
			// 02/03/2016 ECU changed to use Ret... method
			// ---------------------------------------------------------------------
			...
			brandNameSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() 
			{
				...
				public void onItemSelected(AdapterView<?> adapterView, View view,int position, long id) 
				{
					...
					//                spinner is sorted
					// -------------------------------------------------------------
					selectedBrand = ShoppingBrand.GetIndex(adapterView.getItemAtPosition(position).toString());	
					// -------------------------------------------------------------
				}
				// -----------------------------------------------------------------
			...
			productNameSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() 
			{
				...
				public void onItemSelected(AdapterView<?> adapterView, View view,int position, long id) 
				{
					...
					selectedProduct = ShoppingProduct.GetIndex(adapterView.getItemAtPosition(position).toString());	
				}
				// -----------------------------------------------------------------
				public void onNothingSelected(AdapterView<?> arg0) 
				{
		...
		if (theType == TYPE_TRANSACTION)
		{
			...
			itemSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() 
			{
				...
				public void onItemSelected(AdapterView<?> adapterView, View view,int position, long id) 
				{
					...
					selectedItem = ShoppingItem.GetIndex(adapterView.getItemAtPosition(position).toString());	
				}
				// -----------------------------------------------------------------
				public void onNothingSelected(AdapterView<?> arg0) 
				{
			...
			ArrayAdapter<String> shopAdapter = new ArrayAdapter<String>(
				this, R.layout.spinner_row_gray, R.id.spinner_textview,localNames);
			...
			shopSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() 
			{
				...
				public void onItemSelected(AdapterView<?> adapterView, View view,int position, long id) 
				{
					...
					selectedShop = ShoppingShop.GetIndex(adapterView.getItemAtPosition(position).toString());	
				}
				// -----------------------------------------------------------------
				public void onNothingSelected(AdapterView<?> arg0) 
				{
		...
		if (theType == TYPE_LIST)
		{
			...
			//                deleted entries
			// 02/03/2016 ECU changed to use new Ret... method
			// ---------------------------------------------------------------------
			...
			transactionSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() 
			{
				...
				public void onItemSelected(AdapterView<?> adapterView, View view,int position, long id) 
				{
					...
					//                spinner is sorted
					// -------------------------------------------------------------				
					selectedTransaction = ShoppingTransaction.GetIndex (adapterView.getItemAtPosition(position).toString());	
				}
				// -----------------------------------------------------------------
				public void onNothingSelected(AdapterView<?> arg0) 
				{
	...
	public static void YesMethod (Object theSelection)
	{
		...
		// -------------------------------------------------------------------------
		deleteItemConfirmed (ShoppingActivity.selectorParameter.type,(Integer) theSelection);
		// -------------------------------------------------------------------------
