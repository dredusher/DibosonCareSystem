...
public class Complex 
{
    ...
    public Complex times(Complex aComplexNumber) 
    {
        ...
        double realPart 		= a.realPart * aComplexNumber.realPart - a.imaginaryPart * aComplexNumber.imaginaryPart;
        double imaginaryPart 	= a.realPart * aComplexNumber.imaginaryPart + a.imaginaryPart * aComplexNumber.realPart;
    ...
    public Complex times(double theMultiplier) 
    {
        ...
        return new Complex(theMultiplier * realPart, theMultiplier * imaginaryPart);
    }
    /* ========================================================================== */
    ...
    public Complex exp() 
    {
        ...
        return new Complex(Math.exp(realPart) * Math.cos(imaginaryPart), Math.exp(realPart) * Math.sin(imaginaryPart));
    }
    /* ========================================================================== */
    public Complex sin() 
    {
        ...
        return new Complex(Math.sin(realPart) * Math.cosh(imaginaryPart()), Math.cos(realPart) * Math.sinh(imaginaryPart));
    }
    /* ========================================================================== */
    public Complex cos() 
    {
        ...
        return new Complex(Math.cos(realPart) * Math.cosh(imaginaryPart), -Math.sin(realPart) * Math.sinh(imaginaryPart));
    }
    /* ========================================================================== */
    public Complex tan() 
    {
