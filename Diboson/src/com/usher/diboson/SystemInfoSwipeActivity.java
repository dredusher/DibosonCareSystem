...
public class SystemInfoSwipeActivity extends FragmentActivity
{
	/* ============================================================================= */
	// Revision History
	// ================
	...
	// -----------------------------------------------------------------------------
	private static final int PROJECT_LOG_LINES			= 500;
	/* ============================================================================= */
	@Override
	...
	public static class SwipeSectionFragment extends Fragment
	{
									...
									Bundle savedInstanceState) 
		{
			...
			// ---------------------------------------------------------------------
			// 18/09/2020 ECU set the maximum lines of the information field
			//            ECU long entries can wrap across more than one line meaning
			//                that not all of the data is displayed - by adding the
			//                '500' then the problem is resolved.
			// ---------------------------------------------------------------------
			sectionTextView.setMaxLines (StaticData.SYSTEM_INFO_MAX_LINES + 500);
			// ---------------------------------------------------------------------
	...
	static void refreshTextView (int theFragmentNumber,TextView theTextView)
	{
		...
		switch (theFragmentNumber)
		{
			...
			case FRAGMENT_PROJECT_LOG:
				...
				// -----------------------------------------------------------------
				// 23/09/2020 ECU when the project log got very long then an exception
				//                was being thrown so restrict the number of lines
				//                being retrieved
				// -----------------------------------------------------------------
				theTextView.setText (SystemInfoActivity.projectLogData (context,PROJECT_LOG_LINES));
				break;
			// ---------------------------------------------------------------------
