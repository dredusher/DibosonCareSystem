...
public class CustomListViewAdapter extends ArrayAdapter<ListItem>
{
	...
	/* ----------------------------------------------------------------------------- */
	public void ChangeDefaults (int theDefaultImageID,Method theMethodHelp,Method theMethodButton)
	{
		ChangeDefaults (theDefaultImageID,theMethodHelp,theMethodButton,null,null,null);
	}
	/* ----------------------------------------------------------------------------- */
	/* ============================================================================= */
	@Override
				...
				public void onClick(View view) 
				{
					...
					else
					{
						try 
						{
							...
							// ------------------------------------------------------
							methodButton.invoke (null, new Object [] {data.get(thePosition).index});
							// ------------------------------------------------------
						}
				...
				public void onClick(View view) 
				{
					...
					if (methodCustom != null)
					{
						try 
						{
							...
							//                that may have occurred
							// -----------------------------------------------------
							methodCustom.invoke (null, new Object [] {data.get(thePosition).index});
							// -----------------------------------------------------
						}
						catch (Exception theException) 
						{
		...
		itemHolder.helpIcon.setOnClickListener(new OnClickListener() 
		{
		   ...
		   public void onClick(View view) 
		   {
			   ...
			   else
			   {
				   try 
				   {
					   methodHelp.invoke (null, new Object [] {thePosition});
				   }
				   catch (Exception theException) 
				   {
				   }	
			   ...
			   public void onClick(View view) 
			   {
				   ...
				   if (methodImage != null)
				   {
					   try 
					   {
						   ...
						   //                account any sorting
						   // ------------------------------------------------------
						   methodImage.invoke (null, new Object [] {data.get(thePosition).index});
					   }
					   catch (Exception theException) 
					   {
					   }
