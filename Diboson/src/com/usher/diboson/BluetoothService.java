...
public class BluetoothService extends Service
{
		...
		{	
			switch (theMessage.what) 
			{
				...
				case StaticData.MESSAGE_BLUETOOTH_TIMEOUT:
					...
					// 23/04/2020 ECU if the app has been started by the Android OS,
					//                rather than manually, then do not inform the
					//                user that a remote controller cannot be found
					// 08/05/2020 ECU added the check on 'startedByAlarm'
					// -------------------------------------------------------------
					if (PublicData.startedManually  && !PublicData.startedByAlarm)
					{
						// ---------------------------------------------------------
						// 23/04/2020 ECU tell the user that cannot connect to a
						//                remote controller
						// ---------------------------------------------------------
	...
	public static boolean validation (int theArgument)
	{
		...
		// ------------------------------------------------------------------------
		return StaticData.BLUETOOTH_SERVICE;
		// ------------------------------------------------------------------------
	}
	// =============================================================================
}
